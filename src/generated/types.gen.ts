...
export enum ChatModel {
    LYZR_GPT_4_1_NANO = 'lyzr-gpt-4.1-nano',
    LYZR_GPT_4O = 'lyzr-gpt-4o'
}
...
export type ChatResponseEvent = {
    event: StreamEvent;
    data: BeginStream | SearchResultStream | TextChunkStream | RelatedQueriesStream | StreamEndStream | FinalResponseStream | ErrorStream | AgentQueryPlanStream | AgentSearchQueriesStream | AgentReadResultsStream | AgentFinishStream | AgentSearchFullResponseStream;
};
