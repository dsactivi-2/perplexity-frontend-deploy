...
export const $ChatModel = {
    type: 'string',
    enum: ['lyzr-gpt-4.1-nano', 'lyzr-gpt-4o'],
    title: 'ChatModel'
} as const;
...
export const $StreamEvent = {
    type: 'string',
    enum: ['begin-stream', 'search-results', 'text-chunk', 'related-queries', 'stream-end', 'final-response', 'error', 'agent-query-plan', 'agent-search-queries', 'agent-read-results', 'agent-finish', 'agent-full-response'],
    title: 'StreamEvent'
} as const;
